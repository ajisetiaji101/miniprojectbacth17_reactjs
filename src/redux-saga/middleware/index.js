...
import { handleAddCurriculum, handleGetCurriculum, handleGetByIdCurriculum, handleUpdateCurriculum, handleAddCurriculumMateri } from "./CurriculumSaga";
...
import { handleGetJob, handleAddJob, handleDeleteJob, handleEditJob, handleGetIdJob, handleUpdateJobsNoFile } from "./JobSaga";
...
function* watchAll() {
  yield all([
    ...
    takeEvery(ActionTypeCurriculum.GET_BY_ID_CURRICULUM_REQUEST, handleGetByIdCurriculum),
    takeEvery(ActionTypeCurriculum.UPDATE_CURRICULUM_REQUEST, handleUpdateCurriculum),
    takeEvery(ActionTypeCurriculum.ADD_CURRICULUM_MATERI_REQUEST, handleAddCurriculumMateri),
    ...
    takeEvery(ActionTypeJob.UPDATE_JOBSNOFILE_REQUEST, handleUpdateJobsNoFile),
