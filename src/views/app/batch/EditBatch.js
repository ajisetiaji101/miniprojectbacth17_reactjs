...
export default function EditBatch() {
    ...
    const [trainerNamess, setTrainerNamess] = useState([])
    ...
    useEffect(() => {
        setTrainerNamess([...new Set(trainers.map(item => item.inst_bootcamp))])
        console.log("");
    }, [trainers])
    ...
    return userProfile.userRoles === "administrator" ? <>
                            ...
                            <div className="sm:grid sm:grid-cols-5 gap-4">
                                ...
                                <div className="col-span-5 lg:row-start-1 lg:col-span-2">
                                    ...
                                    <select
                                        ...
                                        className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        {trainerNamess && trainerNamess.map((value, index) =>
